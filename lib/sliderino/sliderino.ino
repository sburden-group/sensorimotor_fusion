...
long loopTime = 1001;   // microseconds
...
void loop() {
  ...
  //Slider
  val = analogRead(analogInPinSlider); //Slider min 0-max 674

  //EMG1, A0
  finalReading = analogRead(analogInPinEMG1);
  

  //EMG2, A1
  finalReading2 = analogRead(analogInPinEMG2);

//  Serial.print(finalReading);
//  Serial.print("\t");
//  Serial.println(finalReading2);
